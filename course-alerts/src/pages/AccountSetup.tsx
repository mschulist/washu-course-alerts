    ...
    return (
        ...
        <div className="w-full">
            <form onSubmit={handleSubmit} className="bg-gray-700 shadow-md rounded-2xl mt-8 px-8 pt-6 pb-8 mb-4">
                ...
                <input type="text" name={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"  placeholder="(XXX)-XXX-XXXX"/>
